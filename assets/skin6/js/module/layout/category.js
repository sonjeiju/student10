...
$(document).ready(function() {
  ...
  $('#top_product li').mouseenter(function(e) {
    var $this = $(this).addClass('on')
    if (this.closest('.xans-layout-category').dataset.ezMode == 'manual') {
      return;
    }
  ...
  /* morenvy.com 상단 수동카테고리 */
  jQuery('ul.sub_cate01 li').each(function() {
...
/* morenvy.com 마우스 오버시 class 추가 - 서정환 */
